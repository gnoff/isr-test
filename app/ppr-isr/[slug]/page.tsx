  ...
  return (
    <main>
      ...
      <section>
        ...
        <ul>
          <li><Link href={`/ppr-isr/${slug}a`}>{slug}a</Link></li>
          <li><Link href={`/ppr-isr/${slug}b`}>{slug}b</Link></li>
          <li><Link href={`/ppr-isr/${slug}c`}>{slug}c</Link></li>
        </ul>
        <p><Link href="/ppr-isr">Home</Link></p>
      </section>
    </main>
  );
}
